       ...
       curl -X POST https://api.agentmint.store/a2a \\
         ...
         -d '{"jsonrpc":"2.0","id":1,"method":"agent.create",
              "params":{"name":"general-worker","mode":"all-inclusive",
                        "persona":"You are a general-purpose worker. Handle whatever delegation you receive. Append a 1-2 sentence summary to /workspace/MEMORY.md after each meaningful run."}}'
